...
<body>
    ...
    <div id="quiz">
        <form action="antwoord.php " method="post">
            <div id="vraag1">
                <h6>Hoor je (minstens 1 keer per week) dingen die anderen niet horen, <br>
                zoals ongewone geluiden, stemmen van fluisterende of pratende mensen?</h6>
                <div>
            ...
            <button id="v1-button">volgende vraag</button>
            <div id="vraag2">
            ...
            <div id="v2-button">volgende vraag</div>
            ...
            <div id="v3-button">volgende vraag</div>
            ...
            <div id="v4-button">volgende vraag</div>
            ...
            <div id="v5-button">volgende vraag</div>
            <div id="vraag6">
            ...
            <div id="v6-button">volgende vraag</div>
            <div id="vraag7">
            ...
            <div id="v7-button">volgende vraag</div>
            <div id="vraag8">
            ...
            <div id="v8-button">volgende vraag</div>
            <div id="vraag9">
            ...
            <div id="v9-button">volgende vraag</div>
            <div id="vraag10">
            ...
            <div id="v10-button">volgende vraag</div>
            <div id="vraag11">
            ...
            <div id="submit-button"><input  type="submit" value="Verstuur" /></div>
